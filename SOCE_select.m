...
ylabel('GCamP/TdTomato')
title('Ratio of all ROIs')
xlabel('Time (min.)')
set(gca, 'xlim', timevec([1 end]))
...
line([timevec(marks(1)) timevec(end)],[0.75 0.75],'color','k','Linewidth',2)
text(timevec(marks(1))+0.5*(timevec(end)- timevec(marks(1))),0.85,evnt, ...
